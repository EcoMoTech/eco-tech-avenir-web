...
import styles from '@/styles/Energie.module.css';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 relative overflow-hidden">
          ...
          {/* Formes décoratives */}
          <div className={`absolute top-0 left-0 w-full h-20 bg-white ${styles.clipPathTop}`}></div>
          <div className={`absolute bottom-0 left-0 w-full h-20 bg-white ${styles.clipPathBottom}`}></div>
