      ...
      <main className="flex-grow">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-eco-green via-eco-green/90 to-eco-green/80 py-24 md:py-32">
          <div className="absolute inset-0 opacity-20">
            <div className="absolute top-0 left-0 w-full h-full bg-[url('https://images.unsplash.com/photo-1558965513-b010c9c0621c?ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center" />
          </div>
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 text-white animate-fade-in">
                Chargeurs <span className="text-white bg-eco-green/20 px-2 rounded-md">Domestiques</span>
              </h1>
              <p className="text-xl md:text-2xl text-white/90 max-w-2xl mx-auto mb-8 animate-fade-in">
                Solutions de recharge pratiques et efficaces pour votre domicile
              </p>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6">Rechargez facilement à domicile</h2>
                <p className="text-gray-600 mb-8 text-lg">
                  Nos chargeurs domestiques vous permettent de recharger facilement votre véhicule électrique à la maison. Installation simple et sécurisée par nos techniciens professionnels.
                </p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-bold mb-4">Chargeurs domestiques</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Des solutions de recharge adaptées à vos besoins et à votre installation électrique
              </p>
            </div>
                ...
                <Card key={item} className="overflow-hidden hover:shadow-lg transition-all duration-300">
                  <div className="h-48 bg-gray-100 relative">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <Plug className="h-16 w-16 text-eco-green/20" />
                    </div>
                  </div>
                  <CardContent className="p-6">
                    <Badge className="mb-2 bg-eco-green/10 text-eco-green">Résidentiel</Badge>
                    <h3 className="text-xl font-semibold mb-2">HomePlug {item * 3.7}</h3>
                    <p className="text-gray-600 mb-4">
                      Chargeur domestique {item * 3.7}kW avec connecteur type {item === 1 ? '1' : '2'}, installation incluse.
                    </p>
                    <div className="flex justify-between items-center">
                      <span className="text-xl font-bold text-eco-green">{(item * 300) + 599} €</span>
...
export default ChargeursDomestiques;
